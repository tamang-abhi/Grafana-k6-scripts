...
const URLS = {
  ...
  shop: [
    ...
    '/product-category/jugs/',
    '/product-category/kids/',
    '/product-category/gift-sets-2/',
    '/materials/ceramic/',
  ],
  categories: [
  ...
  products: [
    ...
    '/product/asobu-glacier-bf78/',
    '/product/asobu-happy-hats-sm85/',
    '/product/asobu-food-jar-fj20/',
    '/product/asobu-bestiesling-bp44/',
    '/product/asobu-aspen-bf27/',
    '/product/12-75-oz-pilsner-selection-footed-pilsner-glass-screen-printed-dp826-2/',
    '/product/16-oz-pilsner-selection-beer-glass-screen-printed-dp811-2/',
  ...
  filters: [
    ...
    '/shop/?orderby=popularity&filter_color-catgories=black&query_type_color-catgories=or',
    '/shop/?orderby=popularity&filter_capacity=5-oz-10-oz&query_type_capacity=or',
    '/shop/?orderby=popularity&filter_finish=matte-finish',
    '/shop/?orderby=popularity&filter_finish=matte-finish&filter_color-catgories=pink&query_type_color-catgories=or',
    '/shop/?orderby=popularity&filter_finish=matte-finish&filter_color-catgories=pink&query_type_color-catgories=or&filter_product-category=travel-mug-tumblers&filter_key-features=insulated&filter_capacity=16-oz-20-oz&query_type_capacity=or',
  ],
};
